define(function (require, exports, module){
	...
	function init ( maxStars ){
		...
		starBox.innerHTML = '<div id="canvaszz" class="canvaszz"></div><canvas id="canvas">YOUR BROWSER DO NOT SUPPORT CANVAS</canvas>';
		...
		var w, h, hue, starts, count, maxStarts;
			...
			h = canvas.height = document.documentElement.clientHeight - 6;
